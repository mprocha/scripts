...
webreqlog = '/srv/seiscomp3/bin/seiscomp exec python /srv/seiscomp3/lib/python/webreqlog/webreqlog.py --host 164.41.28.153 -d mysql://sysop:sysop@localhost/external_sc3 --export file:arclinkLOG.html'
system(webreqlog)

# Create a text/plain message
msg = email.mime.Multipart.MIMEMultipart()
msg['Subject'] = 'EXTERNAL Arclink LOG!'
